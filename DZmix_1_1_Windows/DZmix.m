...
legend([q2],{'Mixed sample'},'Location', 'southeast')
leg_cdf=legend([q2],{'Mixed sample'},'Location', 'southeast');
...
xlabel('Age (Ma)')
ylabel('Cumulative probability');
legend([p1 p2],{'Models','Mixed sample'},'Location', 'southeast')
end
...
xlabel('Age (Ma)')
ylabel('Cumulative probability');
legend([p3 p4],{'Models','Mixed sample'},'Location', 'southeast')
end
...
xlabel('Age (Ma)')
ylabel('Cumulative probability');
legend([p1 p2],{'Optimized Model','Mixed sample'}, 'Location','southeast')
...
xlabel('Age (Ma)')
ylabel('Cumulative probability');
legend([p3 p4],{'Optimized Model','Mixed sample'}, 'Location','southeast')
...
xlabel('Age (Ma)')
ylabel('Cumulative probability');
legend([p1 p2],{'Optimized Models','Mixed sample'},'Location','southeast')
...
xlabel('Age (Ma)')
ylabel('Cumulative probability');
legend([p3 p4],{'Optimized Models','Mixed sample'},'Location','southeast')
